...
const contractABI = require("../artifacts/contracts/Linkinfurascan.sol/Linkinfurascan.json").abi;

program
    .name("linkinfurascan-cli")
    .description("CLI tool for Linkinfurascan smart contract")
    .version("1.0.0");
